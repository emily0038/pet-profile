...
import { friendlyTemplateConfig } from '@/lib/templates/editorConfig';
import { createClient } from '@/utils/supabase/client';
import { updateTemplateId } from '@/app/actions/editor';
import { getProfilePath } from '@/utils/url';

export default function FriendlyEditorPage() {
  ...
  const buttonText = isPublishing
    ? 'Publishing...'
    : currentTemplateId === 'friendly'
      ? 'View Page'
      : 'Publish';

  return (
    <TemplateEditor
      config={friendlyTemplateConfig}
      onBack={handleBack}
